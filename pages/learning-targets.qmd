...
[Targets **LS1-3** are introduced on Quiz 1. Targets **PF1**, **PF2**, and **R1** are introduced on Quiz 2. Targets **C1**, **C2**, and **FR1** are introduced on Quiz 3. Targets **G1**, **P1**, and **P2** are introduced on Quiz 4.]{.aside}
