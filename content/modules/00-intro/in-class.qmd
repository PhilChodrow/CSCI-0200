...
- ...took a math class *last semester*.
- ...haven't taken math in *several years*. 
- ...are in their *first* year of college. 
- ...are in their *last* year of college. 
- ...embody axes of **privilege** (upper-income, White, male, cishet, able-bodied, etc.)
- ...embody axes of **marginalization** (lower-income, person of color, female or nonbinary, LGBTQ+, disabled, first-gen, etc.)
- ...have a joyful relationship with math. 
- ...have an adversarial relationship with math. 
