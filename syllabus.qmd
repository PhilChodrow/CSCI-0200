...
**Weeks 1-3**: Course introduction, logic, sets <br> 
**Weeks 4-6**: Proof techniques, functions, relations <br>
**Weeks 7-9**: Counting, recursion <br> 
        ...
        <td class="syllabus-description-table-entry"> 
            ...
            <table style="margin-bottom:0;"> 
                ...
                <tr> 
                    ...
                    <td>
                        Student Hours (usually in the lounge outside 75 SHS 224)
                        <ul style="margin-bottom:0;">
                            <li> Mondays, 2pm-4pm </li>
                            <li> Wednesdays, 11am-12pm </li>
                            <li> Thursdays, 3pm-4pm </li>
                        </ul>
                    </td>
                </tr>   
            </table>
...
On quizzes, you'll demonstrate your ability to <span style="color:#7030a0">**remember**</span>, <span style="color:#0070c0">**understand**</span>, and <span style="color:#00b050">**apply**</span> key ideas and skills. We'll have four quizzes throughout the semester. On each quiz, there will be one question related to each of [the twelve learning targets](pages/learning-targets.qmd) that we have introduced in the course so far. We'll introduce 3 new learning targest in time for each quiz. So, our first quiz will have 3 questions, our second quiz will have 6 questions, our third quiz will have 9 questions, and our last quiz will have 12 questions. You should plan to attempt 2-3 problems on each quiz. 
 
::: {.callout-tip}
Our final exam will be similar to the final quiz, including one question for all 12 learning targets in the course. The only difference is that you'll have 3 hours instead of 50 minutes.  
:::
...
[Here's [a version of this table with checkboxes](pages/checkbox-table.qmd) that you can use to track your progress in the course.]{.aside} 
...
+-----+---------------------------------+---------------------------------+
|**C**|   At least 6                    | - No **N**s                     |
|     |                                 | - At least 6 **M**s or **E**s   |
|     |                                 | - Remainder **R**s              |
+-----+---------------------------------+---------------------------------+

I reserve the right to modify this table, but I promise that I will not make it more difficult to achieve a given grade tier.

#### Partial Completion

When you completely meet both requirements for one tier and completely meet one requirement for a higher tier, you earn the "-" version of the higher tier grade. For example, you may completely meet the requirements of a **B** on Learning Targets and completely meet the requirements of an **A** on Labs. In this case, you earn a minus grade for the higher tier: an **A-**. 
