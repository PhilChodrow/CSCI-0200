...
Extensions are never given on warmups unless under guidance from the DRC. Remember that you can miss up to 3 warmups without any impact on your final grade in the course. 
...
In alignment with [the policy](pages/mask-policy.qmd) of the Department of Computer Science, **you are required to wear masks during scheduled class periods,** unless you have a documented health reason not to wear one. I encourage but do not require you to wear masks during Student Hours and Peer Help sessions. 
